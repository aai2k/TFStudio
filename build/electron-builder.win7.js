 ...
 *
 * The MAIN build (Win10/11) uses package.json `build` as-is, on whatever the
 * `electron` devDependency resolves to. THIS config produces a separate "Win7"
 * installer/portable packaged against Electron 22.3.27, the last Electron line
 * that runs on Windows 7 SP1 / 8 / 8.1 (Electron 23+ requires Windows 10).
 * Chromium 108; Node 18.
 *
 ...
 * the E22 binary via the `electronVersion` override below, so the installed
 * `electron` devDependency and the modern build path are untouched.
 */
