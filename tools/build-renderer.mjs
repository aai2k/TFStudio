...
async function main() {
  ...
  // Icons: renderer references './icons/…png' resolved against the document
  // (build/app/index.html) → build/app/icons/. Also keep build/icons/ for
  // backward compatibility with any other ../icons/ paths.
