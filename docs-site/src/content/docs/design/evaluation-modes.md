...
*ignored* side's tab goes inactive, since you cannot edit a coating you have told
...
| Both    | n/a *(disabled)*  | active    | active   | both      | **TOTAL**     |
| Both + Symmetric | n/a *(disabled)* | active | inactive *(= front)* | both, linked | **TOTAL** |
