...
design's [evaluation mode](/design/evaluation-modes/), whether that is the front
surface, the back surface, or the complete front–substrate–back system. The `Eval`
