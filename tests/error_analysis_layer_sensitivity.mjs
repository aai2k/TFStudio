...
const refinedAR = {
    ...
    incidentMedium: 'Air', exitMedium: 'Air',
    frontLayers: [
        { id: 'L1', material: 'MgF2', thickness: 105.888102, locked: false },
        { id: 'L2', material: 'HfO2', thickness: 51.946010,  locked: false },
        { id: 'L3', material: 'SiO2', thickness: 30.567343,  locked: false },
        { id: 'L4', material: 'HfO2', thickness: 31.058719,  locked: false },
    ],
    backLayers: [],
    surfaceMode: 'front_only',
    meritOperands: [
