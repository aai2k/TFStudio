 ...
 * helpers convert between a stored material object and a draft, validate a
 * draft, and build a live getNK(λ) sampler from a draft for the preview chart.
 * All functions here are pure (no React, no DOM) and unit-tested.
 *
...
// ── Build a live getNK function from a draft (for the preview chart) ──────────
