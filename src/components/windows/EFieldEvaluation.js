...
function EFieldChart({ profileData, pol, matColorMap, c }) {
    ...
    const accentColor = c.accent || '#007acc';
    ...
    const buildTraces = useCallback(() => {
        ...
        // Layer boundary vertical lines as shapes (added in layout)
        return traces;
    }, [profileData, pol]);
    ...
    }, [profileData, pol, bgColor, paperColor, gridColor, textColor, accentColor, matColorMap]);
