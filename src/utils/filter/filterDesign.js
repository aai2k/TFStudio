...
export { buildPrototypeFamily, WIDTH_CONSTANT, WIDTH_CONSTANT_BY_BUILD } from './filterDesign/prototypeFamily.js';
...
export { mulberry32, hashSeed } from './filterDesign/rng.js';
