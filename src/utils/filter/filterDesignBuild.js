...
export function buildFilterDesignObject(p) {
    ...
    const filterLayers = buildPrototypeLayers({
        nH, nL, lambda0_nm, mirrors: candidate.mirrors, spacers: candidate.spacers,
    });
    const adj = adjustToIncidentMedium({
        filterLayers, nH, nL, nInc, nSub, lambda0_nm, mode: arMode,
    });
    ...
    return {
        ...
        filterRecipe: {
            lambda0_nm, halfPass, halfStop, arMode, aoi, pol,
